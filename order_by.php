...
$news="select * from team_members order by ".$_GET['sort'];
if($result = mysqli_query($conn, $news)){
        	echo '
   <table width="50%" cellspacing="0" cellpadding="0" class="tb1" style="opacity: 0.6;">
   <tr><td width="5%" align=center style="padding: 10px;" ><a href="?sort=id">ID</a></td><td width="20%" align=center style="padding: 10px;"><a href="?sort=handle">Handle name</a></td><td width="10%" align=center style="padding: 10px;"><a href="?sort=level">Level</td><td width="40%" align=center style="padding: 10px;"><a href="?sort=expertise">Expertise</td></tr></table>
